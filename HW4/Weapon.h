...
/**
* Weapon(const char* name, Target target1,int hit_strength): creates a weapon type according to the inputs
*
...
**/
    ...
    explicit Weapon(const char* name, Target target1,int hit_strength);
/**
