...
**/
    GameStatus addPlayer(const string player_name,const string weapon_name,Target target1,int hit_strength);
/**
...
**/
    ...
    GameStatus nextLevel(const string player_name);
/**
 ...
 * 	NAME_DOES_NOT_EXIST - there is no player with that name
**/
    GameStatus makeStep(const string player_name);
/**
...
**/
    ...
    GameStatus addLife(const string player_name);
/**
...
**/
    ...
    GameStatus addStrength(const string player_name, int strength_to_add);
/**
...
**/
    ...
    GameStatus fight(const string player_name1, const string player_name2);
...
**/
    friend void SortPlayers(vector<Player*> players ,int players_n);
};
